...
from data import transform_cifar, transform_imagenet, transform_svhn, ImageFolder, ISIC2016, OCTDataset, transform_isic2016, transform_oct
...
def load_pretrained_herding(args):
    ...
    if args.dataset == 'imagenet':
        ...
        train_dataset = ISIC2016("../", train=True, transform=transform_isic2016())
        val_dataset = ISIC2016("../", train=False, transform=transform_isic2016())
    elif args.dataset == 'oct':
        train_dataset = OCTDataset(args.data_dir, train=True, transform=transform_oct())
        val_dataset = OCTDataset(args.data_dir, train=False, transform=transform_oct())
