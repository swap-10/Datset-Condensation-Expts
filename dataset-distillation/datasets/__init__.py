...
dataset_normalization = dict(
    ...
    ISIC2016=((0.4914, 0.4822, 0.4465), (0.247, 0.243, 0.261)),
)
...
def get_dataset(state, phase):
    ...
    if name == 'MNIST':
        ...
        return isic2016.ISIC2016(root, phase, transforms.Compose(transform_list))
    else:
